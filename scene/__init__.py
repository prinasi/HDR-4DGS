...
class Scene:
    ...
    def __init__(self, args : ModelParams, gaussians : GaussianModel, load_iteration=None, shuffle=True, resolution_scales=[1.0], num_pts=50_000, num_pts_ratio=1.0, time_duration=None):
        """b
        ...
        if not self.loaded_iter:
            ...
            for i, cam in enumerate(camlist):
                json_cams.append(camera_to_JSON(i, cam))
